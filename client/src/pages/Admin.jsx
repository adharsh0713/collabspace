    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600 mt-2">Manage seats and rooms for your organization</p>
            </div>
            ...
            <div className="mt-6">
                {activeTab === 'seats' ? (
                    <Card className="p-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-6">Create New Seat</h2>
                    ...
                    <Card className="p-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-6">Create New Room</h2>
